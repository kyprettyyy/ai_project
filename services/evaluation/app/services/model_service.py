...
from app.schemas.model import ModelVO, ModelQueryRequest, GatewayModelResponse
...
class ModelService:
    ...
    async def sync_models_from_gateway(self) -> int:
        """
        从 EvalRoute Gateway 同步模型列表
        ...
        try:
            async with httpx.AsyncClient() as client:
                response = await client.get(
                    f"{settings.gateway_openai_base_url}/models",
                    headers={
