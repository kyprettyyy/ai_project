...
from app.api.model_profile import router as model_profile_router
from app.api.openai_compat import router as openai_compat_router
from app.api.routing_audit import router as routing_audit_router
...
def create_app() -> FastAPI:
    ...
    app.include_router(model_profile_router, prefix=settings.app_base_path)
    app.include_router(openai_compat_router, prefix=settings.app_base_path)
    app.include_router(routing_audit_router, prefix=settings.app_base_path)
