"""EvalRoute SDK main client."""

from __future__ import annotations

from evalroute_sdk.callback import StreamCallback
from evalroute_sdk.config import ClientConfig
from evalroute_sdk.http_client import HttpClient
from evalroute_sdk.models import ChatRequest, ChatResponse


class EvalRouteClient:
...
class ClientConfigBuilder:
    ...
    def build(self) -> EvalRouteClient:
        config = ClientConfig(
