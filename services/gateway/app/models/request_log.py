...
class RequestLog(Base):
    ...
    task_type: Mapped[str | None] = mapped_column("taskType", String(64), nullable=True)
    provider_name: Mapped[str | None] = mapped_column("providerName", String(64), nullable=True)
