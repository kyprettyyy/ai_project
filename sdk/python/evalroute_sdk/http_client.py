...
from evalroute_sdk.models import ChatChunk, ChatRequest, ChatResponse, StreamResponse
...
class HttpClient:
    ...
    def _raise_for_status(response: httpx.Response) -> None:
        ...
        raise EvalRouteError(message, status_code=response.status_code)
