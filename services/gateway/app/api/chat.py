...
async def chat_completions(
    ...
    payload.evaluation_run_id = payload.evaluation_run_id or request.headers.get("X-Eval-Run-Id")
    payload.task_type = payload.task_type or request.headers.get("X-Task-Type") or "general"
