...
from app.core.constants import (
    ...
    ROUTING_STRATEGY_ADAPTIVE,
    ROUTING_STRATEGY_FIXED,
)
from app.exceptions.business_exception import BusinessException
from app.models.model import Model
from app.models.model_provider import ModelProvider
from app.schemas.chat import ChatMessage, ChatRequest, ChatResponse, GatewayMetadata, StreamChoice, StreamDelta, StreamResponse
...
class ChatService:
    ...
    async def _call_single_model(
        ...
        try:
            ...
            request_cost = self.billing_service.calculate_cost_from_model(
            ...
            response.gateway = GatewayMetadata(
                ...
                taskType=chat_request.task_type or "general",
                evaluationRunId=chat_request.evaluation_run_id,
